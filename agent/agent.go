...
type Agent interface {
	...
	MountCIFSShare(ctx context.Context, deviceName, sharePath, userName, password string) (err error)
	UnmountCIFSShare(ctx context.Context, deviceName string) (err error)
